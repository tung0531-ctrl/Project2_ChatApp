...
import { getBotClinicModelCachePath, hasBotClinicModelCache } from "./modelCache.js";
...
export const botClinicClassifierConfig = {
  type: "svm",
  alpha: 0.8,
  learningRate: 0.08,
  decay: 0.01,
...
export const createBotClinicDefinition = () => {
  ...
  return {
    ...
    classifier: {
      ...
      pretrainedModelPath: hasPretrainedModel ? getBotClinicModelCachePath() : null,
    },
    systemUser: {
    ...
    examples: hasPretrainedModel ? [] : getBotClinicTrainingExamples(),
    entities: {},
